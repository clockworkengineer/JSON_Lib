...
TEST_CASE("Check JSON stringification to XML of simple types.", "[JSON][Stringify][Simple][XML]")
{
  ...
  SECTION("XML encode an string with unprintable characters (1-127) ", "[JSON][Stringify][XML][String]")
  {
  ...
  // SECTION("XML encode an string with unprintable characters (128-255) ", "[JSON][Stringify][XML][String]")
  // {
  //   std::string escaped{ "\"abcdefghijklmnopqrstuvwxyz" };
  //   // Add all ASCII except '"' and '\'
  ...
  SECTION("Stringify a boolean (false) to XML.", "[JSON][Stringify][Boolean][XML]")
  {
    BufferDestination jsonDestination;
  ...
  SECTION("Stringify a integer (98345) to XML.", "[JSON][Stringify][Integer][XML]")
  {
    BufferDestination jsonDestination;
  ...
  SECTION("Stringify a floating point (55.6667) to XML.", "[JSON][Stringify][Float][XML]")
  {
    BufferDestination jsonDestination;
  ...
  SECTION(R"(Stringify [{},{},{}] to a XML.)", "[JSON][Stringify][Array][XML]")
  {
    BufferDestination jsonDestination;
    json.parse(BufferSource{ R"([{},{},{}])" });
    json.stringify(jsonDestination);
  ...
  SECTION(R"(Stringify {"Test" : [[],[],[]]} to a XML.)", "[JSON][Stringify][Object][XML]")
  {
    BufferDestination jsonDestination;
