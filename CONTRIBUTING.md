# Contributing to JSON_Lib

Thank you for your interest in contributing to JSON_Lib! We welcome bug reports, feature requests, and pull requests.
...
5. **Ensure all tests pass** and the project builds cleanly with no warnings (use `-DJSON_WARNINGS_AS_ERRORS=ON`).
